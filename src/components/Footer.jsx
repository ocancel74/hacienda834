        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <a href="#inicio" className="inline-block mb-4">
              ...
              />
              {/* Fallback texto */}
              <span className="items-center gap-2 hidden" style={{display:'none'}}>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {LINKS.slice(0, 5).map(link => (
                <li key={link.href}>
                  <a href={link.href} className="text-sm hover:text-sand-300 transition-colors">
                    {link.label}
                  </a>
                </li>
              ))}
          ...
          <div>
            <h4 className="text-white font-semibold text-sm uppercase tracking-wider mb-5">&nbsp;</h4>
            <ul className="space-y-2">
            ...
            <ul className="space-y-3">
              ...
              <li className="pt-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-500 text-white text-xs font-semibold px-4 py-2.5 rounded-full transition-colors"
                >
                  <MessageCircle className="w-4 h-4" />
